...
dir("G:/Shared drives/NMFS NWC FRAM EDC CE (contains MSA Confidential Data)/FISHEyE/data/PerformanceMetrics")
...
destination <- ifelse(grepl('fisheye_perfmets', getwd()), "data", "Performancemetrics/data")
