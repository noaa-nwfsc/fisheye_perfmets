...
tags$div(
    ...
    tags$div(
        ...
        p(
            'Please note that availability of filters will vary between sectors.'
        ),
        tags$br(),
        h4("Fisheries"),
        p(
            'FISHEyE uses the same fisheries definitions as those used by the',
            tags$a(
        ...
        tags$br(),
        p(
            'Complete information is unavailable for the Alaskan portion of vessels fishing operations, but information about the role of 
        ...
        p(
            "For shorebased processors, information on the EDC form is collected at the species level (e.g. fish production information), not the 
                     fishery level like the catcher vessels."
        ),
        tags$ul(
            tags$li(strong("Pacific whiting:"), 'Pacific whiting.'),
            tags$li(
                strong("Non-whiting groundfish:"),
                'Arrowtooth flounder; Dover sole; English sole; Lingcod; Pacific sanddab; 
                              Petrale sole; Rex sole; Rockfish; Sablefish (black cod); Thornyheads; Sharks, skates, and rays.'
            ),
            tags$li(
                strong("Other species:"),
        ...
        p(
            "The",
            tags$a(
                href = "http://127.0.0.1:4612/map.pdf",
                'homeport',
                target = "_blank"
            ),
        ...
        p(
            'The state corresponding to each homeport. Vessels that report their homeport to be in Alaska are included in Washington State.'
        ),
        tags$br(),
        h4('Region'),
        p(
            'The region corresponding to each processor. For first receivers and shorebased processors, two regions are recognized: Washington and Oregon and California.'
        ),
        tags$br(),
        ...
        h4("Processor size"),
        p(
            "First receivers and shorebased processors are grouped into three size classes based on the average number of workers: large (> 200 workers), medium (100 - 200 workers), and 
