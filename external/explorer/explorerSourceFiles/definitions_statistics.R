...
tags$div(
    ...
    tags$div(
        h3("Statistics"),
        p(
            'The statistic provided depends upon the metric selected. For instance, the mean or median per day or per metric ton is 
                     only available for Economic and Cost metrics.'
        ),
        tags$br(),
        h4("Median or mean"),
        p(
            'The median and mean provide information about a representative vessel; however, they do it in different ways. The 
        ...
        tags$ul(
            ...
            tags$li(
                strong(
                    "Per vessel or processor per metric ton caught/purchased:"
                ),
                "Median or Mean per metric ton of fish caught or purchased for all vessels or processors 
                              that participated in the catch share program."
            ),
            tags$li(
                strong("Per vessel or processor per metric ton produced:"),
                "Median or Mean per metric ton of fish products for all vessels or processors 
                              that participated in the catch share program."
            )
        ),
        tags$br(),
        h4('Fleet-wide total'),
        p(
            "The fleet-wide total measures how the entire fleet is doing, rather than a representative vessel. Summed over all vessels or processors that 
