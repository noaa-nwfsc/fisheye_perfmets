...
tags$div(
    ...
    tags$div(
        ...
        p(
            'FISHEyE lets you choose whether you would like to create multiple figures, one for each selected vessel/processor category or one for 
        ...
        h4("Show variance"),
        p(
            "This functionality allows user to include a variance band on the plots. When plotting mean the variance band represents the mean plus or minus 
