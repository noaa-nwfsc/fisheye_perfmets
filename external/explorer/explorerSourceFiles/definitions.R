...
tags$div(
    ...
    tags$div(
        p(
            "The variables and their definitions used in 
             this application are from the",
            tags$a(
                href = "http://www.nwfsc.noaa.gov/research/divisions/fram/documents/EDC_Catcher_Vessel_Report_2015.pdf",
                '2012 Economic Data Collection (EDC) report. ',
                target = "_blank"
            ) #,
        ),
        tags$div(
            ...
            tags$ul(
                p(
                    'Select whether to compare groups of vessels or processors based on selected summary variables (see below) or by metrics. For the mothership and catcher-processor sectors, the only summary variable available is At-sea Pacific whiting.'
                ) #,
            ...
            p(
                'Please note that availability of summary variables will vary between sectors.'
            ),
            tags$ul(
                tags$li(
                    strong("Fisheries:"),
                    'The Performance Metrics application uses the same fisheries definitions as those used by the',
                    tags$a(
                    ...
                    'to characterize the',
                    tags$a(
                        href = "http://www.westcoast.fisheries.noaa.gov/fisheries/groundfish/",
                        'US West Coast Groundfish fishery. ',
                        target = "_blank"
                    ),
                    ' Many vessels that participate in the catch share program also participate in other fisheries such as Dungeness crab or Alaskan fisheries. 
                              ...
                              and vessel length class. When viewing fisheries,activities from Alaskan fisheries are included in the ',
                    tags$em('All non-catch share fisheries combined'),
                    ' category. Sample size is insufficient to show results for this fishery alone.'
                ),
                p(
                    tags$i('Catch Share fisheries:'),
                    ' Pacific whiting (includes at-sea and shoreside Pacific whiting); At-sea Pacific whiting; 
                ...
                p(
                    tags$i('Non-catch Share fisheries:'),
                ...
                tags$li(
                    ...
                    'For shorebased processors, information on the EDC form  is collected at the species level (e.g. fish production information), not the fishery level like the catcher vessels.'
                ),
                p(tags$i('Pacific whiting:'), ' Pacific whiting.'),
                p(
                    tags$i('Non-whiting groundfish:'),
                    ' Arrowtooth flounder; Dover sole; English sole; Lingcod; Pacific sanddab; Petrale sole; Rex sole; Rockfish; Sablefish (black cod); Thornyheads; Sharks, skates, and rays.'
                ),
                p(
                    tags$i('Other species:'),
                    ' Coastal pelagics (including sardines and mackerel); Crab; Enchinoderms (including sea urchins and sea cucumbers);
                       California halibut; Pacific halibut; Pacific herring; Salmon; Squid; Sturgeon; Tuna; Other shellfish; Other species.'
                ),
                tags$li(
                    strong("Homeport:"),
                    "The",
                    tags$a(href = "map.pdf", "homeport", target = "_blank"),
                ...
                tags$li(
                    strong("State of homeport:"),
                    "The state corresponding to each homeport. Vessels that fished off the West coast but report their homeport to be in Alaska are included. These vessels are included in Washington State."
                ),
                tags$li(
                    strong("Region:"),
                    "The region corresponding to each processor. For first receivers and shorebased processors, two regions are recognized:",
                    tags$em('Washington and Oregon'),
                    'and',
                    tags$em("California.")
                ),
                tags$li(
                    strong("Vessel length class:"),
                    "Three categories of vessel length representing the range of catcher vessel length: large vessels (> 80 ft), medium vessels (> 60 ft, <= 80 ft), and small vessels (<= 60 ft)."
                ),
                tags$li(
                    strong("Processor size:"),
                    "First receivers and shorebased processors are grouped into three size classes based on the average number of workers: large (> 200 workers), medium (100 - 200 workers), and small (< 100 workers).
            ...
            tags$ul(
                tags$li(
                    strong('Vessel or processor characteristics:'),
                ...
                tags$li(
                    strong('Economic:'),
                    'Metrics within the economic indicators section describe the potential economic impacts of the catch share fishery on the West Coast. Changes may be indicative of changes in total allowable catch (TAC), fish or product prices, costs or cost structure, profitability, productivity, and diversification.'
                ),
                tags$li(
                    strong('Labor:'),
                    'Distribution of benefits and costs among crewmembers. Indicators describe potential impact on individuals (i.e., wages) and employment (i.e. number of positions).'
                ),
                tags$li(
                    strong('Cost:'),
                    'Variable and fixed costs presented by sub-category. Please note that the availability of cost measures will vary by sector.'
                ),
                tags$li(
                    strong('Impacts:'),
                    'Income and employment impacts for the West Coast overall.'
                ),
                tags$li(
                    strong('Other:'),
                    'Broad collection of metrics that extend beyond the other types of indicators and describe effort, productivity, inequality, and the temporal and spatial distribution of landings.'
                )
            ),
            h4('Metrics'),
            p(
                'Please note that availability of metrics will vary between sectors.'
            ),
            #Erin- Review definitions for vessel replacement value, vessel market value and vessel horsepower.
            tags$ul(
                h4(tags$em('Vessel or processor characteristics')),
                tags$li(
                    strong('Number of vessels or processors: '),
                    'Number of vessels fishing or number of processing companies processing.'
                ),
                tags$li(
                    strong('Vessel length: '),
                    'Length of vessels in feet.'
                ),
                tags$li(
                    strong('Vessel replacement value: '),
...
<tr>
   <td style="text-align:left; padding-left: 2em;" indentlevel="1"> California halibut, Coastal pelagics, Crab, Echinoderms, Nonspecies specific product, Other species, Pacific halibut, Pacific herring, Squid, Salmon, Other shellfish, Tuna, Shrimp, Sturgeon </td>
                ...
                tags$li(
                    strong('Proportion of revenue from catch share fishery: '),
            ...
            tags$ul(
                h4(tags$em("Economic")),
                tags$em(
                    "Values reported in inflation adjusted",
                    currentyear,
                    "dollars."
                ),
                ...
                tags$li(
                    ...
                    tags$ul(
                        ...
                        "for the full listing of variable cost categories."
                    )
                ),
                tags$li(
                    strong("Fixed cost:"),
                ...
                tags$li(
                    strong("Variable cost net revenue (VCNR):"),
                    "Revenue minus variable costs.",
                    tags$br(),
                    "VCNR is a measure of the operating profit of the average vessel."
                ),
                tags$li(
                    strong("Total cost net revenue (TCNR):"),
                    'Revenue minus variable and fixed costs. Over many years, TCNR is a measure of long-term profitability.',
                    tags$br(),
                ...
                tags$p(
                    strong('A note about net revenue:'),
                    'The',
                    tags$a(
                        href = "http://www.nwfsc.noaa.gov/research/divisions/fram/economic/economic_data_forms.cfm",
                        'EDC forms',
                    ...
                    'capture costs that are directly related to vessel fishing operations, and do not include other expenses 
            ...
            tags$ul(
                h4(tags$em('Cost')),
                tags$li(
                    'Quota earnings and costs are currently excluded due to data limitations. 
                ...
                tags$li(
                    strong("A note about total costs."),
                    ' There are a variety of costs that are associated with operating a vessel or processing facility that are not requested on the form because it is difficult to determine the 
        ...
        the facility. For these reasons, the aggregated measures of costs presented here underestimate the true costs of operating a business.'
            ...
            tags$ul(
                h4(tags$em('Impacts')),
                tags$li(
                    'Please refer to this document for more information about impacts: https://www.nwfsc.noaa.gov/assets/25/1620_08012011_142237_InputOutputModelTM111WebFinal.pdf'
                ),
                tags$li(
                    strong('Income impacts: '),
                    'West Coast-wide income generated by the selected vessels from activities in the selected fishery.'
                ),
                tags$li(
                    strong('Employment impacts: '),
            ...
            tags$ul(
                ...
                tags$li(
                    strong('Share of landings by state: '),
                    'Share of landings (deliveries) by all vessels, by whiting vessels, and by non-whiting groundfish vessels in each state or at-sea. Shares are in terms of revenue. When selecting the ',
                    tags$em('State'),
                    'summary variable, this metric shows the share of landings in each state for vessels that homeport in the selected state. This selection highlights that vessels may deliver fish in multiple states.'
                ),
                tags$li(
                    strong('Seasonality: '),
            ...
            tags$p(
                strong(
                    'The statistic provided depends upon the metric selected. '
                ),
                'For instance, the mean or median per day or per metric ton is only available for economic metrics.'
            ),
            tags$ul(
                tags$li(strong("Median or Mean")),
                tags$ul(
                    tags$li(
                        strong("Per vessel or processor:"),
                        "Median or Mean for all vessels or processors that participated in the catch share program."
                    ),
                    tags$li(
                        strong("Per vessel or processor per day:"),
                        "Median or Mean per day for all vessels or processors that participated in the catch share program."
                    ),
                    tags$li(
                        strong("Per vessel or processors per metric ton:"),
                ...
                tags$br(),
                tags$li(
                    strong("Fleet-wide total:"),
                    "Summed over all vessels or processors that participated in the catch share program. For rates measurements (per day at sea or metric ton), we show the fleet-wide or industry-wide average.
            ...
            tags$ul(tags$p(
                tags$strong(
                    "What is the purpose of using median, mean, and fleet-wide total values when looking at the data?"
                ),
                "The median and mean provide information about a representative vessel; 
                                   however, they do it in different ways.  The ",
                tags$strong("median"),
                "means that half of the vessels have a larger result than the median, and half are smaller.  The ",
                tags$strong("mean "),
                "
                ...
                tags$em('skewed'),
                "by extreme responses, then the median is a better measure for a typical vessel.  The ",
                tags$strong("fleet-wide total"),
                "measures how the entire fleet is doing, rather than a representative vessel."
            )),
            tags$br(),
            ...
            tags$ul(
                tags$p(
                    "For the catcher vessel sector, the selected metric is calculated at three levels: 1) for the fleet as a whole, 2) for vessels that fished for Pacific whiting, and 3) for vessels that participate in the non-whiting groundfish sector of the limited entry trawl fishery. 
            ...
            tags$ul(
                tags$p(
                    'For some metrics, you may choose whether or not to include activities in Alaskan fisheries. If this box',
                    tags$strong('is selected,'),
            ...
            h4('Years'),
            tags$ul(
                'The catch share program began in 2011. A mandatory',
                tags$a(
            ...
            tags$ul(
                tags$li(
                    strong('Year:'),
                    'Calendar year over which fishing activities occurred.'
                ),
                tags$li(
                    strong('Summary variables:'),
                    'Summary variables (fisheries, homeport, state, vessel length class) are used to group vessels to better understand the economic performance of particular segments of the fleet.'
                ),
                tags$li(
                    strong('Metric:'),
                    'See above for a description of the individual metrics. This column is not included when an economic indicator is selected.'
                ),
                tags$li(
                    strong('Economic measure:'),
                    'See the economic metric section above for a description of the economic measures.'
                ),
                tags$li(
                    strong('Number of vessels/processors:'),
                    'The number of observations for each displayed statistic.'
                ),
                tags$li(
                    strong('Statistic:'),
                    'See above for further description of the statistics.'
                ),
                tags$li(
                    strong('Value:'),
                    'Value of the metric or economic measure for the selected statistic.'
                ),
                tags$li(
                    strong('Alaskan fisheries:'),
                    'Include activities in Alaskan fisheries  (Vessels included or Vessels not included).'
                ),
                tags$li(
                    strong('Data summed across:'),
                    'For catcher vessels, we show data summed across all vessels, vessel that participated in the non-whiting groundfish sector of the limited entry trawl fishery, vessels that fished for Pacific whiting. Vessels that fished for both whiting and non-whiting are included in the whiting level.
                ...
                tags$li(
                    strong('Fisheries Category:'),
                    'This variable is relevant for when vessels are grouped by homeport, state, or vessel length class. It indicates whether the reported value of the selected metric or economic 
                                      measure includes activity in all fisheries or only in the catch share fisheries or the non-catch share fisheries.'
                ),
                tags$li(
                    strong('Production Category:'),
                    'This variable is relevant for when processors are grouped by region or processor size. It indicates whether the reported value of the selected metric or economic 
                                      measure includes all production or only groundfish production or other species production.'
                ),
                tags$li(
                    strong('Variance:'),
                    'A measure of the spread of values. We report the standard deviation (SD) when vessel/processor mean are selected and upper and lower quartiles (25th/75th percentiles) when vessel/processor medians are selected.'
                ),
                tags$li(
                    strong('Delivery location:'),
                    'This variable is only relevant for the',
                    tags$em('Share of landings by state'),
                    'metric. This variable indicates location of landings.'
                ),
                tags$p(tags$br(), tags$br(), tags$br(), tags$br())
            )
        )
    )
)
