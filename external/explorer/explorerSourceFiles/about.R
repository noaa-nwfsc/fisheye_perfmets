tags$div(
    style = "margin: 15px; 15px;30px; 30px; width: 60%",
    HTML(
        "<div style='display:inline-block;width:100%;padding:0;line-height: 0.72em; margin-top:5px; margin-bottom:5px;'>
                     <h3>About</h3></div>"
    ),
    #  tags$h3('About Net Revenue Explorer', style="border-top:10px; padding-top:10px; margin-top:10px"),
    tags$p(
        tags$br(),
        "Welcome to FISHeries Economics Explorer (FISHEyE) Performance Metrics page for the ",
        tags$a(
    ...
    tags$p(
        'The catch share program was instituted with several goals, including:'
    ),
    tags$ul(
        tags$li(
    ...
    tags$p(
        'FISHEyE Performance Metrics provides metrics to assess the effectiveness and outcomes of the catch share program. The metrics are not intended to be interpreted as causal (i.e., X caused Y change), 
    ...
    tags$p(
        'Data used in FISHEyE comes from',
        tags$a(
    ...
    tags$p(
        'FISHEyE Performance Metrics is user driven and interactive. Information on how to use FISHEyE Performance Metrics is available in the',
        tags$em("Instructions"),
        'tab.
                Information on the variables in the dataset and definitions of the statistics and metrics used are found in the',
        tags$em("Definitions"),
        'tab.'
    ),
    tags$p(
        'The metrics provided are not an exhaustive list of potential performance metrics. They were chosen based on their ability to present meaningful information about the fishery 
        ...
        tags$a(
            href = 'https://dataexplorer.northwestscience.fisheries.noaa.gov/fisheye/NetRevExplorer/',
            'FISHEyE Net Revenue Explorer.',
            target = "_blank"
        )
    ),
    ...
    p(
        'Data confidentiality requirements do not allow us to show individual observations. Therefore, we aggregate or summarize the data to protect individual confidentiality.'
    ),
    p(
        'Data queries that would display confidential data are not plotted or made available to download. In these cases, a message will appear below the figure to indicate that data 
    ...
    p(
        "There are some cases where there are not enough vessels to differentiate between results summed across all vessels, whiting vessels, and non-whiting vessels. This occurs when there 
    ...
    HTML(
        "<div style='display:inline-block;width:100%;padding:0;line-height: 2.35em; margin-top:5px; margin-bottom:10px;'>
    ...
    tags$ul(
        tags$li(tags$a(
            ...
            "Economic and Social Science Research (ESSR) Program at the NWFSC",
            target = "_blank"
        )),
        tags$li(
            tags$a(
                href = "http://www.nwfsc.noaa.gov/research/divisions/fram/economic/overview.cfm",
                "The Economic Data Collection (EDC) Program",
                target = "_blank"
            ),
            tags$ul(
                #tags$li( "EDC General Information")),
                tags$li(tags$a(
                ...
                tags$li(tags$a(
                    ...
                    "Infographic describing the sectors participating in the catch share program",
                    target = "_blank"
                ))
            )
        )
    ...
    tags$h3("Disclaimer"),
    tags$p(
        "The data used in this application are periodically updated and subject to change.See the blog post for information on when data were last updated."
    ),
    ...
    tags$p(
        "There are numerous individuals to thank for their contributions in developing FISHEyE. We thank the Northwest Fisheries Science Center (NWFSC) 
