tags$div(
    ...
    tags$div(
        ...
        h4("Vessel type"),
        p(
            "We include the option to summarize data by three types of vessels: 1) All vessels: the fleet as a whole, 2) Whiting vessels: vessels that fished for Pacific whiting, 
        ...
        p(
            "The purpose of separating the whiting from the non-whiting vessels is that the whiting vessels tend to be larger and catch a higher volume of fish. In addition, 
        ...
        p(
            "There is only one type of mothership and catcher-processor because they only species they process if Pacific whiting."
        ),
        p(
            "Where possible, data are reported for all vessels combined, whiting vessels, and non-whiting vessels. If there are fewer than three vessels in either the 
        ...
        h4("Processor type"),
        p(
            "We include the option to summarize data by three types of processors: 1) All processors: processed catch share fish purchases, 2) Whiting processors: processed Pacific whiting, 
        ...
        p(
            "For some metrics (e.g., Fishery diversification, Number of fisheries), you may choose whether or not to include activities in Alaskan fisheries."
        ),
        tags$br(),
        h4("Years"),
        p(
